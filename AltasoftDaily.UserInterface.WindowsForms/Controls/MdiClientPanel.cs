...
namespace AltasoftDaily.UserInterface.WindowsForms.Controls
{
    ...
    public class MdiClientPanel : Panel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SizeChanged += MdiClientPanel_SizeChanged;

            _ctlClient.MaximumSize = this.Size;
        }

        void MdiClientPanel_SizeChanged(object sender, EventArgs e)
        {
            _mdiForm.Size = this.Size;
            _mdiForm.MaximumSize = this.Size;
            _mdiForm.MinimumSize = this.Size;
        }
